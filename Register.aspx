                        ...
                        <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                            <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                                ...
                                <h4 class="mb-0" style="text-align: center; color: #000">
                                    ...
                                    <br />
                                    <span style="text-align: center">Please Enter full informations for Register</span>
                                </h4>
                                ...
                                <div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="col-md-12">
                                            <div class="position-relative mb-3">
                                                <asp:TextBox ID="TextBox3" class="form-control" runat="server" Style="border-radius: 30px; border: 1px solid #ddd; text-align: center" placeholder="Full Name "></asp:TextBox>

                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="position-relative mb-3">
                                                <asp:TextBox ID="TextBox4" class="form-control" runat="server" Style="border-radius: 30px; border: 1px solid #ddd; text-align: center" placeholder="E-Mail Address "></asp:TextBox>
                                           ...
                                           <div class="col-md-12">
                                            <div class="position-relative mb-3">
                                                <asp:TextBox ID="TextBox5" class="form-control" runat="server"  Style="border-radius: 30px; border: 1px solid #ddd; text-align: center" placeholder="Phone1"></asp:TextBox>
                                           ...
                                           <div class="col-md-12">
                                            <div class="position-relative mb-3">
                                                <asp:TextBox ID="TextBox6" class="form-control" runat="server"  Style="border-radius: 30px; border: 1px solid #ddd; text-align: center" placeholder="Phone2 "></asp:TextBox>
                                    ...
                                    <div class="divider row"></div>
                                    <asp:Button ID="Button1" runat="server" Style="width: 100%" Text=" Register" class="mb-2 me-2 btn-pill btn btn-outline-2x btn-outline-primary active" />

                                    <a href="Default.aspx">you have account...? Login</a>
